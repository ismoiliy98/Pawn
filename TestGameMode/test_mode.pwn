...
{
    SendClientMessageToAllf(playerid, 0xCD0000FF, "playerid - %d, damagedid - %d, amount - %f, weaponid - %d, bodypart - %d", playerid, damagedid, Float:amount, weaponid, bodypart);
	return 1;
}

public OnPlayerTakeDamage(playerid, issuerid, Float:amount, weaponid, bodypart)
{
	SendClientMessageToAllf(playerid, -1, "playerid - %d, issuerid - %d, amount - %f, weaponid - %d, bodypart - %d", playerid, issuerid, Float:amount, weaponid, bodypart);
	return 1;
}
